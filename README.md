...
This repo will demostrate how to deploy a app to a Kubernetes Cluster on AWS (EKS) using AWS Codepipeline.

A sample Kubernetes service used in the CI/CD Pipeline module.
...
In the kubernetes.yml file, you will find the Kubernetes [service](https://kubernetes.io/docs/concepts/services-networking/service/) and
